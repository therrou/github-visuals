...
const Swirl: React.FC<SwirlProps & any> = (props) => {
    ...
    const yOff = 0.005
    const zOff = 0.0005
    const backgroundColor = props.backgroundColor || 'hsla(99,50%,3%,0)'
    let tick = 0
